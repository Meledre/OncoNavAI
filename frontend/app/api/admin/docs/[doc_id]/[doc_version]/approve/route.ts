  ...
  try {
    ...
    if (!doc_id || !doc_version) {
      return bffError(
        ...
        "/admin/docs/[doc_id]/[doc_version]/approve"
      );
    }
    return await proxyToBackend({
      request,
      backendPath: `/admin/docs/${doc_id}/${doc_version}/approve`,
      method: "POST",
      allowedRoles: ["admin"]
    });
  } catch (error) {
    return bffError(
      ...
      `BFF_UPSTREAM_NETWORK_ERROR (/admin/docs/[doc_id]/[doc_version]/approve): ${
